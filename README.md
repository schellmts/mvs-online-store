...
Este projeto tem como finalidade simular uma loja de produtos esportivos, onde os produtos sao registrados via api, onde também é possível fazer uma simulação de tempo de entrega via cep.
